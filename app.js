...
// arrow functions are not able to access .this infomration, therefor they are not able to be used within constructor functions.
...
// 'this' is reffering to the object this becuase of the regular function being used.
// 2. What is "this" when joe.scopeArrow() is invoked
// 'this' is the entire window.
// 3. Explain why "this" is different when an arrow function is used.
// 'this' is the entire window. arrow functions do not have the ability to contain 'this' so this will scope to the next highest scope.
